...
public class BuildVars {
    ...
    // TODO: ОБЯЗАТЕЛЬНО ЗАМЕНИТЕ на свои ключи от https://core.telegram.org/api/obtaining_api_id
    public static int APP_ID = 4; // ← DUMMY значение! ЗАМЕНИТЕ на свой APP_ID
    public static String APP_HASH = "014b35b6184100b085b0d0572f9b5103"; // ← DUMMY! ЗАМЕНИТЕ на свой APP_HASH

    // SafetyNet key for Google Identity SDK, set it to empty to disable
    public static String SAFETYNET_KEY = "AIzaSyDqt8P-7F7CPCseMkOiVRgb1LY8RN1bvH8";
    public static String PLAYSTORE_APP_URL = "https://play.google.com/store/apps/details?id=com.messenger.secure";
    public static String HUAWEI_STORE_URL = ""; // Установите свою ссылку на Huawei AppGallery
    ...
    public static boolean isBetaApp() {
        if (betaApp == null) {
            betaApp = ApplicationLoader.applicationContext != null && "com.messenger.secure.beta".equals(ApplicationLoader.applicationContext.getPackageName());
        }
        return betaApp;
    }
